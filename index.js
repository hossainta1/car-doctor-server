...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.rysigvn.mongodb.net/?retryWrites=true&w=majority`;
    ...
    try {
        ...
        app.get('/bookings', verifyJwt, async (req, res) => {
            ...
            if (decoded.email !== req.query.email) {
                ...
                return res.status(403).send({ error: 1, message: 'Forviden Access denied' })
